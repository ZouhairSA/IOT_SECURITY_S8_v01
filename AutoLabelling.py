...
class AutoLabellingObjectDetect:
    def __init__(self):
        ...
        # self.out_txt_path: str = 'datasets/labels/val'  # Plus besoin de ce chemin
        self.prompt: str = 'eye'
    ...
    def save_data(self, image_copy: np.ndarray, list_info: list, image_name: str):
        """Save image and bounding box info to MongoDB"""
        # Sauvegarder l'image sur le disque
        cv2.imwrite(f"{self.out_image_path}/{image_name}.jpg", image_copy)
        ...
        self.db.insert_data("annotations", annotation_data)
        ...
        while self.cont < self.num_images:
            ...
            if len(boxes) != 0:
                ...
                if self.save:
                    ...
                    self.save_data(copy_image, self.bbox_info, time_now)
